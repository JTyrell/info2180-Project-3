...
function createUser(Fname, Lname, Pwrd1, email, phone){
    ...
    var url = " https://info2180-project3-rijkaa.c9users.io/addUser.php/";
    var result;
    Fname = "?Fname="+ Fname ;
    Lname= "&Lname=" +Lname;
    ...
    httpRequest.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if(result == 'true'){
                ...
                window.alert(result);
                window.location.replace(" https://info2180-project3-rijkaa.c9users.io/addUser.html");
                return false;
            }
        }
    };
...
window.onload = function() {
    var submit = document.getElementById("newUserBtn");
